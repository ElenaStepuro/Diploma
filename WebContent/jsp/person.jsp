			...
			<div class="container">
				...
				<div class="collapse navbar-collapse nav-wil"
					...
					<ul class="nav navbar-nav">
						...
						<li class="active"><a
							href="/EPM-CAS/controller?command=show_person">Persons</a></li>
			...
			<div class="bs-docs-example animated wow fadeInUp"
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							<td rowspan="2">1</td>
							<td rowspan="2">Ivanov Sergey Kirillovich</td>
							<td rowspan="2">ivanovsergey@gmail.com</td>
							<td rowspan="2">mars190</td>
							<td rowspan="2">+79531261734</td>
							<td rowspan="2">A2</td>
							<td rowspan="2">A1</td>
							<td rowspan="2">A2+</td>
						...
						<tr>
							<td rowspan="2">2</td>
							<td rowspan="2">Pechenkina Alexandra Olegovna</td>
							<td rowspan="2">alexandra@gmail.com</td>
							<td rowspan="2">mars190</td>
							<td rowspan="2">+79521548733</td>
							<td rowspan="2">B1+</td>
							<td rowspan="2">B1</td>
							<td rowspan="2">A2+</td>
							<td rowspan="2">Not draft</td>
				...
				<form action="controller" method="get">
					...
					<div class="input-group animated wow fadeInUp"
						...
						<span class="input-group-addon" id="basic-addon2">Person</span> <select
							...
							<option selected="person">Ivanov Sergey</option>
							<option>Pechenkina Alexandra</option>
							...
							<option selected="requisition">AT:IN_17_1</option>
							<option>J:EX_17_1</option>
							<option>FE:IN_16_1</option>
						</select>
					</div>
			...
			<div class="bs-docs-example animated wow fadeInUp"
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td rowspan="2">2</td>
							<td rowspan="2">Pechenkina Alexandra</td>
